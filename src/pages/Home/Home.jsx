  ...
  return (
    <div className="min-h-screen text-[#F5F5F5] px-10 md:px-5 lg:px-10">
      <section className="grid md:grid-cols-2 gap-10 items-center py-6">
        <div>
          <h2 title="TagLines" className="text-4xl md:text-5xl font-bold text-[#5C6BC0] leading-tight h-40 font-serif">
            {displayedText}
            <span className="border-r-2 border-[#5C6BC0] animate-pulse" />
          </h2>
          <p className="mt-10 text-lg md:text-xl text-[#B0BEC5] max-w-xl font-serif">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link to="/boycott" className="bg-[#D7CCC8] font-mono text-[#1A1A1A] hover:bg-[#5C6BC0] hover:text-white px-6 py-3 rounded-lg font-semibold transition">
              Discover alternatives
            </Link>
            <Link to="/mailprotest" className="bg-[#5C6BC0] font-mono text-white hover:bg-[#3949AB] px-6 py-3 rounded-lg font-semibold transition">
      ...
      <section className="text-center my-5">
        <blockquote className="italic text-[#90A4AE] text-lg max-w-3xl mx-auto cursor-crosshair font-mono">
        ...
        <Link to="/about" className="block mt-4 text-[#5C6BC0] hover:underline font-mono">
      ...
      <section className="my-20 grid md:grid-cols-3 gap-10">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold font-serif text-[#5C6BC0]">Boycott Lookup</h3>
          <p className="mt-2 font-mono text-[#B0BEC5]">Search for unethical companies and see ethical alternatives on broad basis.</p>
          <Link to="/boycott" className="inline-block font-mono mt-3 text-[#D7CCC8] hover:text-[#5C6BC0] font-medium">
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold font-serif text-[#5C6BC0]">One-Click Mail</h3>
          <p className="mt-2 text-[#B0BEC5]">Send powerful pre-written proposal emails to decision-makers.</p>
          <Link to="/mailprotest" className="inline-block font-mono mt-3 text-[#D7CCC8] hover:text-[#5C6BC0] font-medium">
            Send Now ⇨
          </Link>
        </div>
        ...
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold font-serif text-[#5C6BC0]">Suggest better alternatives detailed</h3>
          <p className="mt-2 font-mono text-[#B0BEC5]">A B2B feature that suggests ethical alternatives to reduce dependency on unethical companies.</p>
      ...
      <section className="text-center py-10 bg-[#2A2A2A] rounded-xl mt-20">
        <h2 className="text-2xl font-serif font-bold text-[#5C6BC0]">Our Collective Impact</h2>
        <p className="text-[#B0BEC5] font-mono mt-2">Here’s what we’ve achieved together:</p>
